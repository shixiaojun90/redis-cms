...
// 定义应用加密 KEY
define('G_COOKIE_HASH_KEY', 'coogerdsfhkdsjfh');
...
// 以下为需要 define 的常量
define('VERSION',  '1.0'); // YOF VERSION
define('TB_PK',        'id');  // 表的主键, 用于 SelectByID 等
define('TB_PREFIX',    'aac_'); // 表前缀
define('APP_NAME',     'cms'); // APP 名称
define('LIB_PATH',     APP_PATH.'/application/library');
define('LANG_PATH',     APP_PATH.'/application/language');
...
define('MENU_PATH', APP_PATH.'/application/common');
// API KEY for api sign
define('API_KEY', 'THIS_is_OUR_API_keY');

define('RSA_PATH',APP_PATH.'/conf');

// CSS, JS, IMG PATH
define('CSS_PATH', '/css');
define('JS_PATH',  '/js');
define('IMG_PATH', '/img');
define('WIDGET_PATH', '/widget');

// Admin CSS, JS PATH
define('ADMIN_CSS_PATH', '/admin/css');
define('ADMIN_CORE_PATH',  '/admin/core');
